  ...
  <div class="login-container">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" auto-complete="on" label-position="left">
      ...
      <div class="title-container">
        <h3 style="color: black;" class="title">基于区块链的农产品溯源系统</h3>
      </div>
...
.login-container {
  // 添加背景图片
  background-image: linear-gradient(rgba(255, 255, 255, 0.3), rgba(255, 255, 255, 0.3)), url("../../assets/login_images/cute_background.png");
